...
async function obterRestaurantes(cidade, especialidade, raio, climaDescricao) {
    ...
    const url = `https://api.yelp.com/v3/businesses/search?location=${cidade}${termo}&radius=${raio * 1000}`;
